...
/*! \file
    ...
    CAxCryptWin - The windows implementation of callbacks and functions for AxCryptLib
...
namespace axcl {
    /// \brief A Windows-specific wrapper around the callback functionality of AxCryptLib
    ///
    ...
    /// the underlying AxCryptLib-functionality. These in turn, will at the appropriate
