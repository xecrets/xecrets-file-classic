...
#define AXCRYPTLIB_H
/*! \file
    \brief AxCryptLib.h - An AxCrypt support library

    @(#) $Id: AxCryptLib.h 1177 2008-01-08 08:27:50Z svante $

    AxCryptLib - An AxCrypt support library

    This interface may be used directly by code implementing AxCrypt-functions.
...
//#include "AxAssert.h"
//#define AXLIB_ASSERT_FILE "AxCryptLib.h"
...
/// \brief The C-library interface to AxCrypt functions
...
enum {
    ...
    AXCL_A_TCHAR2UNICODE,                   ///< Convert from TCHAR (possibly Unicode) to Unicode - possibly a null operation
    AXCL_A_UNICODE2TCHAR,                   ///< Convert from Unicode to TCHAR (possibly Unicode) - possibly a null operation
    ...
    AXCL_E_BAD_GUID,                        ///< Not an AxCrypt file
...
/// All of the buffers must be left to be managed by AxCryptLib at all times.
enum {
